  ...
  drawConstraint(constraint) {
    ...
    if (constraint.image) {
      ...
      const angle = Math.atan2(
        posB.y + offsetB.y - (posA.y + offsetA.y),
        posB.x + offsetB.x - (posA.x + offsetA.x)
      );
      ...
      image(
        ...
        this.offset.x,
        this.offset.y,
        constraint.image.width * this.attributes.scale,
        constraint.image.height * this.attributes.scale
      );
      pop();
    } else {
      line(
